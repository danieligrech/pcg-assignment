...
public class SkyscraperWindow15 : MonoBehaviour
{
    ...
    private void CreateCube(){
        ...
        this.transform.position = new Vector3(-31.3999996f,42.2000008f,2.70000005f);
        ...
        meshRenderer.materials = materialsBuilder.MaterialsListWindow().ToArray();
    }
}
